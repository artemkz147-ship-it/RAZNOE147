export const HEROES = [
  {id:'donut_knight',name:'Золотая Рыцарка',asset:'hero01',weapon:'donut',cost:0,desc:'Стойкий стрелок: больше здоровья, брони и стабильности под давлением.',bonus:{armor:.12,hp:.08}},
  {id:'dew_fairy',name:'Лесная Эльфийка',asset:'hero02',weapon:'firefly',cost:0,desc:'Мобильный следопыт: быстрее получает опыт и притягивает трофеи.',bonus:{xp:.16,pickup:.18}},
  {id:'hamster_pirate',name:'Капитан Бомба',asset:'hero03',weapon:'pirate_bomb',cost:0,desc:'Пират-бомбардир: мощные дальние взрывы и повышенная удача.',bonus:{luck:.20,splash:.16}},
  {id:'candy_witch',name:'Призматическая Ведьма',asset:'hero04',weapon:'rainbow_fan',cost:900,desc:'Маг залпового огня: широкая веерная атака и высокий базовый урон.',bonus:{damage:.12,projectiles:1}},
  {id:'mushroom_druid',name:'Зелёная Авантюристка',asset:'hero05',weapon:'flower_burst',cost:1250,desc:'Контролирует толпу дальними клинками ветра и замедляет наступление.',bonus:{area:.18,slow:.08}},
  {id:'cat_mage',name:'Янтарный Маг',asset:'hero06',weapon:'amber_comet',cost:1600,desc:'Точный магический стрелок: пробивает линии врагов и быстро перезаряжается.',bonus:{cooldown:.12,pierce:1}},
  {id:'toy_robot',name:'Лазурная Стражница',asset:'hero07',weapon:'blast_bot',cost:1950,desc:'Защитный класс с самонаводящимися метательными топорами.',bonus:{damageReduction:.10,homing:.18}},
  {id:'baker_alchemist',name:'Боевой Алхимик',asset:'hero08',weapon:'pancake',cost:2300,desc:'Огненный жезл выпускает пробивающие заряды, а герой постепенно лечится.',bonus:{duration:.20,regen:.18}},
  {id:'fox_archer',name:'Лазурный Стрелок',asset:'hero09',weapon:'fox_bow',cost:2650,desc:'Скоростной лучник с повышенным шансом критического попадания.',bonus:{speed:.12,crit:.08}},
  {id:'cloud_princess',name:'Небесная Путница',asset:'hero10',weapon:'cloud_orb',cost:3000,desc:'Штормовой маг: быстрые самонаводящиеся заряды и повышенное уклонение.',bonus:{projectileSpeed:.16,dodge:.08}},
  {id:'watermelon_captain',name:'Штормовой Корсар',asset:'hero11',weapon:'watermelon',cost:3350,desc:'Тяжёлые взрывные стрелы разбрасывают плотные группы противников.',bonus:{knockback:.22,splash:.18}},
  {id:'music_gnome',name:'Северный Громовержец',asset:'hero12',weapon:'music_wave',cost:3700,desc:'Громовые импульсы расходятся кругом и пробивают окружившую толпу.',bonus:{area:.12,cooldown:.08}},
  {id:'lightning_bee',name:'Ниндзя Искра',asset:'hero13',weapon:'smart_bee',cost:4050,desc:'Самый быстрый герой: зачарованные кинжалы сами доворачивают к целям.',bonus:{speed:.15,cooldown:.08}},
  {id:'snow_penguin',name:'Полярный Разведчик',asset:'hero14',weapon:'snowball',cost:4400,desc:'Ледяные залпы замедляют врагов, а герой постепенно восстанавливается.',bonus:{regen:.35,slow:.14}},
  {id:'pumpkin_jester',name:'Гоблинка-Охотница',asset:'hero15',weapon:'pumpkin',cost:4750,desc:'Метает парные боевые топоры и усиливает взрывные комбинации.',bonus:{luck:.12,splash:.12}},
];
...
export const WEAPONS = [
  {id:'donut',name:'Солнечный Посох',evolution:'Корона Солнца',model:'weapon01',projectile:'star',type:'fan',damage:17,cooldown:.68,speed:23,count:3,spread:.11,pierce:1,range:31,scale:.20,passive:'area',fx:0xffcf6b},
  {id:'firefly',name:'Флакон Зарниц',evolution:'Рой Зарниц',model:'weapon02',projectile:'gem',type:'chain',damage:15,cooldown:.64,speed:24,count:1,chain:4,chainRadius:6.4,range:31,scale:.20,passive:'cooldown',fx:0x8effc8},
  {id:'pirate_bomb',name:'Рунный Молот',evolution:'Пороховой Шторм',model:'weapon03',projectile:'bomb',type:'bomb',damage:32,cooldown:1.18,speed:15,count:1,splash:4.2,range:29,scale:.28,passive:'area',fx:0xff7b48},
  {id:'rainbow_fan',name:'Призматический Гримуар',evolution:'Семицветная Буря',model:'weapon04',projectile:'star',type:'fan',damage:12,cooldown:.70,speed:22,count:7,spread:.15,pierce:1,range:28,scale:.17,passive:'projectiles',fx:0xff78dc},
  {id:'flower_burst',name:'Клинок Ветра',evolution:'Шторм Клинков',model:'weapon05',projectile:'arrow',type:'fan',damage:14,cooldown:.70,speed:25,count:5,spread:.19,slow:.18,range:29,scale:.24,passive:'area',fx:0x98f2ff},
  {id:'amber_comet',name:'Янтарный Фокус',evolution:'Янтарная Сверхновая',model:'weapon06',projectile:'gem',type:'shot',damage:28,cooldown:.78,speed:30,count:1,pierce:4,range:35,scale:.24,passive:'power',fx:0xffb54a},
  {id:'blast_bot',name:'Грозовой Топор',evolution:'Штормовой Арсенал',model:'weapon07',projectile:'weapon07',type:'homing',damage:23,cooldown:.98,speed:17,count:2,homing:7,splash:2.7,range:32,scale:.22,passive:'cooldown',fx:0x73d9ff},
  {id:'pancake',name:'Огненный Жезл',evolution:'Пылающая Комета',model:'weapon08',projectile:'fire',type:'shot',damage:21,cooldown:.82,speed:24,count:2,pierce:3,range:31,scale:.23,passive:'duration',fx:0xff9b4c},
  {id:'fox_bow',name:'Лисий Лук',evolution:'Ливень Лисьих Стрел',model:'weapon09',projectile:'arrow',type:'shot',damage:22,cooldown:.62,speed:32,count:1,pierce:2,crit:.14,range:37,scale:.27,passive:'crit',fx:0xffa24c},
  {id:'cloud_orb',name:'Штормовой Посох',evolution:'Грозовой Спутник',model:'weapon10',projectile:'gem',type:'homing',damage:17,cooldown:.58,speed:20,count:3,homing:9,pierce:1,range:31,scale:.20,passive:'speed',fx:0xb9e9ff},
  {id:'watermelon',name:'Золотой Лук',evolution:'Небесная Баллиста',model:'weapon11',projectile:'arrow',type:'bomb',damage:38,cooldown:1.18,speed:23,count:1,splash:4.8,knockback:2.8,range:34,scale:.31,passive:'area',fx:0xffdc72},
  {id:'music_wave',name:'Молот Грома',evolution:'Громовой Венец',model:'weapon12',projectile:'star',type:'radial',damage:13,cooldown:1.02,speed:21,count:10,pierce:2,range:24,scale:.17,passive:'projectiles',fx:0x8e8cff},
  {id:'smart_bee',name:'Кинжалы Роя',evolution:'Королевский Рой',model:'weapon13',projectile:'weapon13',type:'homing',damage:15,cooldown:.42,speed:22,count:3,homing:11,range:30,scale:.18,passive:'cooldown',fx:0xffe45d},
  {id:'snowball',name:'Морозный Посох',evolution:'Полярная Буря',model:'weapon14',projectile:'gem',type:'fan',damage:15,cooldown:.70,speed:20,count:4,spread:.15,slow:.34,range:28,scale:.19,passive:'duration',fx:0x9feaff},
  {id:'pumpkin',name:'Двойной Топор',evolution:'Вихрь Берсерка',model:'weapon15',projectile:'weapon15',type:'boomerang',damage:27,cooldown:.86,speed:21,count:2,pierce:5,range:25,scale:.20,passive:'area',fx:0xff873f},
...
const maps = [
  ['sunny_meadow','Солнечный луг','Большая светлая долина с рощами, лагерями и каменными тропами','forest','#6fb35b','#d9f1bd','#8ecb75','tree'],
  ['magic_forest','Изумрудная чаща','Глубокий лес с кристальными полянами и древними стоянками','forest','#315b4d','#74cba7','#4f8d70','tree'],
  ['candy_park','Сад цветения','Яркий парк с цветочными аллеями, арками и павильонами','park','#d88aaa','#fff0c9','#f1abc4','birch'],
  ['pumpkin_village','Янтарная деревня','Осенняя деревня с домами, рынком и старыми дорогами','village','#a96645','#ffd49b','#c78753','deadTree'],
  ['snow_festival','Снежная долина','Светлая зимняя долина с хвойными рощами и лагерями','snow','#dce8ef','#f8fbff','#b8d5e6','rock'],
  ['toy_castle','Лазурная цитадель','Солнечный каменный двор с арками, башнями и укреплениями','castle','#789cc4','#f5e4aa','#9fbde0','column'],
  ['bubble_beach','Сапфировый берег','Песчаная бухта с пальмами, лагерями и водной границей','beach','#d9bd79','#c7f5ff','#e9d590','rock'],
  ['cheese_moon','Лунное плато','Кратеры, кристаллы и холодный звёздный горизонт','moon','#a69b78','#1d2442','#b5aa8c','rock'],
  ...
  ['cookie_desert','Золотые дюны','Тёплая пустыня с оазисами, руинами и скальными проходами','desert','#c79662','#f6cf8f','#d9aa74','rock'],
  ['firefly_swamp','Болото светлячков','Влажное болото с огнями','swamp','#496d53','#9fcf83','#557b5d','tree'],
  ['music_fair','Солнечная ярмарка','Праздничная площадь с арками, лавками и огнями','fair','#bd7d72','#ffe1a2','#d29588','arch'],
  ...
  ['festival_finale','Лучезарный фестиваль','Большая праздничная столица с павильонами и сияющими площадями','festival','#cf7489','#ffe6a9','#e294a6','arch']
];
...
const layouts = {
  ...
  park:[['flower',-20,-18,2.2],['flower',18,-16,2.5],['gem',-16,17,2.4],['gem',17,19,2.0],['arch',0,-25,4.0],['column',-8,0,3.0],['column',8,0,3.0],['bush',-18,0,1.2],['bush',18,0,1.2]],
  village:[['deadTree',-23,-17,4.5],['deadTree',21,-18,4.8],['arch',0,-24,4.0],['column',-15,7,3.2],['column',15,7,3.2],['rock',-9,17,1.5],['rock',10,18,1.8],['rock',0,8,1.8]],
  ...
  beach:[['rock',-25,-16,2],['rock',25,-16,2],['tree',-22,17,5],['tree',22,18,5],['bush',-10,10,1.4],['bush',12,8,1.5]],
  ...
  desert:[['deadTree',-22,-18,4],['deadTree',22,18,4],['rock',18,-16,2.4],['rock',-18,15,2.2],['flower',0,-20,2.2],['flower',0,20,2.5]],
  swamp:[['tree',-23,-18,5],['tree',21,-19,4.7],['tree',-21,18,4.8],['tree',22,16,5],['torch',-8,0,2],['torch',8,0,2],['bush',0,19,1.2]],
  fair:[['arch',0,-25,5],['column',-20,-14,4],['column',20,-14,4],['column',-20,14,4],['column',20,14,4],['gem',-8,12,1.8],['flower',9,12,1.8],['torch',0,20,2]],
  ...
  festival:[['arch',0,-27,5],['arch',0,27,5],['column',-24,-14,4],['column',24,-14,4],['column',-24,14,4],['column',24,14,4],['gem',-10,16,2],['flower',10,16,2],['gem',0,0,1.8],['torch',0,-18,2]]
};

export const MAPS = maps.map((m,i)=>({
  id:m[0],name:m[1],desc:m[2],layout:m[3],ground:m[4],sky:m[5],accent:m[6],barrier:m[7],
  width:188+(i%3)*14,height:154+(i%4)*12,unlockWins:i===0?0:i,enemyTier:i,bossIndex:i,
...
export const HELD_PROFILES={
 ...
 pancake:['weapon08',.56,'shoot',[.05,-.14,-.03],[0,.10,.05],'low'],
