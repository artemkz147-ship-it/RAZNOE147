...
export const DAILY_QUESTS = [
  {id:'daily_kills',name:'Натиск дня',text:'Уничтожить 180 врагов',stat:'kills',target:180,reward:260},
  {id:'daily_levels',name:'Сила растёт',text:'Получить 12 уровней',stat:'levels',target:12,reward:220},
  {id:'daily_survive',name:'Не сдавайся',text:'Выжить 8 минут суммарно',stat:'survive',target:480,reward:240}
];

export const CAREER_QUESTS = [
  {id:'career_kills',name:'Победитель толпы',text:'Уничтожить 2500 врагов',stat:'kills',target:2500,reward:1200},
  {id:'career_wins',name:'Герой фестиваля',text:'Победить 10 раз',stat:'wins',target:10,reward:1500},
  {id:'career_bosses',name:'Укротитель гигантов',text:'Победить 12 боссов',stat:'bosses',target:12,reward:1800},
  {id:'career_maps',name:'Путешественник',text:'Победить на 8 разных картах',stat:'mapWins',target:8,reward:1600}
];
