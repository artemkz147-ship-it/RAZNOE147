...
export const ASSET_URLS = (()=>{
  const a={floor:'./assets/floor.glb',tree:'./assets/tree.glb',deadTree:'./assets/dead-tree.glb',bush:'./assets/bush.glb',rock:'./assets/rock.glb',grass:'./assets/grass.glb',grassShort:'./assets/grass-short.glb',snowRock:'./assets/snow-rock.glb',pineSnow:'./assets/pine-snow.glb',birch:'./assets/birch.glb',birchAutumn:'./assets/birch-autumn.glb',willow:'./assets/willow.glb',cactus:'./assets/cactus.glb',palm:'./assets/palm.glb',mossRock:'./assets/moss-rock.glb',gem:'./assets/gem.glb',arch:'./assets/arch.glb',column:'./assets/column.glb',chest:'./assets/chest.glb',torch:'./assets/torch.glb',fire:'./assets/fire.glb',flower:'./assets/flower.glb',bomb:'./assets/bomb.glb',arrow:'./assets/arrow.glb',star:'./assets/star.glb',cloud:'./assets/cloud.glb',snow:'./assets/snow.glb',bee:'./assets/bee.glb',mini_robot:'./assets/mini-robot.glb',food_donut:'./assets/food-donut.glb',food_watermelon:'./assets/food-watermelon.glb',food_pancake:'./assets/food-pancake.glb',food_pumpkin:'./assets/food-pumpkin.glb',food_cookie:'./assets/food-cookie.glb'};
