...
class Game {
  ...
  resetRunState() {
    ...
    this.scene.add(this.player.root); this.attachSword(this.player.root); this.player.mixer=new THREE.AnimationMixer(this.player.root); this.playPlayerAnim('idle',true,.12); if(this.player.action){this.player.action.time=.55;this.player.mixer.update(0);} if(this.player.action){this.player.action.time=.55;this.player.mixer.update(0);} if(this.player.action){this.player.action.time=.55;this.player.mixer.update(0);} if(this.player.action){this.player.action.time=.55;this.player.mixer.update(0);} if(this.player.action){this.player.action.time=.55;this.player.mixer.update(0);} if(this.player.action){this.player.action.time=.55;this.player.mixer.update(0);}
    this.updateHud();
  }
