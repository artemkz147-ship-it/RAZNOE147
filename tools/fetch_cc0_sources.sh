...
# High-resolution / layered stage bases.
...
for spec in 'AbandonCity:AbandonCity.zip' 'DarkCity:DarkCity.zip' 'StarryNight:StarryNight.zip' 'Industrial:Industrial.zip' 'StreetsOfFight:StreetsOfFight.zip'; do
